...
function ProgressBar({ current, target, label, color = '#0c0a09' }) {
...
export default function TierProgress() {
  ...
  const tierColors = { hercules: '#0c0a09', atenea: '#0c0a09', zeus: '#0c0a09' };
  const Icon = tierIcons[data.current_tier] || Award;
  const color = tierColors[data.current_tier] || '#0c0a09';
