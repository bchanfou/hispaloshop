          ...
          >
            ...
            <div className="flex shrink-0 items-center justify-between border-b border-stone-100 px-4 py-3.5">
              ...
              <button
                ...
                className="flex items-center gap-1 text-[14px] font-semibold text-[#0095f6] disabled:opacity-50 active:opacity-50"
              >
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain">
              ...
              <div className="flex flex-col items-center py-6">
                ...
                <button
                  ...
                  className="mt-2 text-[13px] font-semibold text-[#0095f6] active:opacity-50 disabled:opacity-50"
                >
