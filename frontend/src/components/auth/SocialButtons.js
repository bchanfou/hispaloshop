...
const SocialButton = ({ provider, onClick, fullWidth = false }) => {
  const config = {
    google: {
      icon: (
...
const SocialButtons = ({ onGoogleClick, onFacebookClick, onAppleClick }) => {
  return (
    <div className="space-y-3">
      <SocialButton provider="google" onClick={onGoogleClick} fullWidth />
