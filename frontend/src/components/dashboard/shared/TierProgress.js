...
function TierProgress({ currentTier, currentRate, nextTier, progress, onViewBenefits }) {
  ...
  return (
    <div className="bg-gradient-to-r from-[#2D5A3D] to-[#3d7a52] rounded-2xl p-4 text-white">
      <div className="flex items-center gap-2 mb-3">
        <Trophy className="w-5 h-5 text-[#E6A532]" />
      ...
      <div className="space-y-2">
        ...
        <div className="h-2 bg-white/20 rounded-full overflow-hidden">
          <motion.div
            ...
            className="h-full bg-[#E6A532] rounded-full"
          />
        </div>
