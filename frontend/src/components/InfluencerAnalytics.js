    ...
    <Card>
      <CardContent className="pt-6">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-sm text-text-muted font-body">{title}</p>
    ...
    return (
      <Card>
        <CardContent className="py-12 text-center">
          ...
          <p className="text-text-muted">No hay datos de analytics disponibles</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <div className="space-y-6" data-testid="influencer-analytics">
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
        ...
        <StatCard
          ...
          color={summary.click_to_order_rate > 5 ? "text-green-600" : "text-primary"}
        />
        <StatCard
          icon={TrendingUp}
        ...
        <CardContent className="py-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white rounded-lg p-4 border border-green-200">
              <p className="text-sm font-medium text-primary mb-2">Cálculo de tu comisión:</p>
            ...
            <div className="bg-white rounded-lg p-4 border border-green-200">
              <p className="text-sm font-medium text-primary mb-2">Calendario de pagos:</p>
              <ul className="space-y-1 text-sm text-text-secondary">
