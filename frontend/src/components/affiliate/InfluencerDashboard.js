      ...
      <div className="bg-stone-950 text-white border-0 rounded-2xl">
        <div className="p-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <button
              onClick={copyLink}
              className="px-4 py-2 border border-stone-200 text-stone-600 rounded-2xl hover:bg-stone-50 transition-colors gap-2 shrink-0 flex items-center bg-white"
            >
        ...
        <div className="border border-stone-200 rounded-2xl bg-white">
          ...
          <div className="px-5 pb-5">
            <div className="w-full bg-stone-200 rounded-full h-3">
              <div
                className="bg-stone-950 h-3 rounded-full transition-all"
            ...
            <div className="space-y-3">
              {top_products && top_products.length > 0 ? (
                top_products.map((product) => (
                  <div
                    key={product._id}
                    className="flex justify-between items-center p-3 bg-stone-50 rounded-2xl hover:bg-stone-100 transition"
                  >
                ...
                recent_conversions.map((conv, idx) => (
                  ...
                  >
                    {conv.product_image ? (
                      ...
                      <div className="w-12 h-12 bg-stone-200 rounded flex items-center justify-center shrink-0">
...
function StatCard({ icon: Icon, label, value, highlight }) {
  return (
    <div className={`border rounded-2xl bg-white ${highlight ? 'border-stone-500 border-2' : 'border-stone-200'}`}>
      <div className="p-4">
    ...
    <div className="space-y-3">
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 px-3 py-2 border rounded-2xl focus:outline-none focus:ring-2 focus:ring-stone-500 border-stone-200"
        />
        <button
      ...
      {generatedLink && (
        <div className="flex items-center gap-2 p-3 bg-stone-50 rounded-2xl">
          ...
          <a
            ...
            className="text-stone-950 hover:text-stone-700"
          >
