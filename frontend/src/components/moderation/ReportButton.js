  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs text-stone-400 transition-colors hover:bg-stone-100 hover:text-stone-600"
      >
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  {REASONS.map(({ key, label }) => (
                    <button
                      ...
                      className={`flex w-full items-center justify-between rounded-2xl border px-4 py-3 text-left text-sm transition-all duration-150 ${
                        reason === key
                          ? 'border-stone-950 bg-stone-50 font-medium text-stone-950'
                          : 'border-stone-100 text-stone-700 hover:border-stone-200 hover:bg-stone-50'
                      }`}
                    >
                      {label}
                      {reason === key && (
                ...
                <button
                  ...
                  className="h-12 w-full rounded-full bg-stone-950 text-sm font-medium text-white transition-colors hover:bg-stone-800 disabled:opacity-40"
                >
