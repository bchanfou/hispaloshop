...
const STEPS = [
  { id: 1, label: 'Identidad', title: t('application.quienEres', 'Quién eres') },
  { id: 2, label: 'Audiencia', title: 'Tu tribu' },
  { id: 3, label: t('application.confirmacion', 'Confirmación'), title: 'Elige tu camino' },
];

const COUNTRY_OPTIONS = [
  t('admin.countries.ES', 'España'),
  t('admin.countries.MX', 'México'),
  'Argentina',
  'Colombia',
  'Chile',
  'Perú',
...
const TIERS = [
  {
    ...
    helper: t('application.recomendadoParaLaMayoria', 'Recomendado para la mayoría.'),
    icon: Gem,
  },
  {
    key: 'atenea',
    ...
    helper: t('application.pideRevisionManualPrioritaria', 'Pide revisión manual prioritaria.'),
    icon: BadgeCheck,
  },
  {
    key: 'zeus',
    ...
    helper: t('application.paraPerfilesConUnaComunidadMuyActi', 'Para perfiles con una comunidad muy activa.'),
    icon: Crown,
  },
];
...
export default function ApplicationModal({ open, onOpenChange }) {
  ...
  const toggleNiche = (value) => {
    ...
    setErrors((current) => ({ ...current, niches: undefined }));
  };
                  ...
                  <div className="overflow-hidden rounded-[34px] border border-stone-200 bg-stone-950 p-8 text-white shadow-[0_30px_80px_rgba(28,28,28,0.28)] sm:p-10">
                    ...
                    <p className="mt-5 max-w-2xl text-base leading-7 text-white/80">
                      {submittedTier === 'hercules'
                        ? t('application.herculesEntraPorViaRapidaHemosMar', 'Hércules entra por vía rápida. Hemos marcado tu perfil para activación inmediata y siguientes pasos.')
                        : t('application.tuPerfilPasaARevisionHumanaSiApl', 'Tu perfil pasa a revisión humana. Si aplicaste a Atenea o Zeus, te responderemos en 24-48h con una decisión real, no automática.')}
                    </p>
                    ...
                    <button
                      ...
                      className="mt-6 text-sm font-medium text-white/80 underline-offset-4 hover:text-white hover:underline"
                    >
                      Volver a la landing
                    </button>
                  </div>
                            ...
                            <div className="mt-8 grid gap-5 md:grid-cols-2">
                              ...
                              <label className="block">
                                ...
                                <input
                                  ...
                                  placeholder={t('application.reusSeulCiudadDeMexico', 'Reus, Seúl, Ciudad de México...')}
                                  className="h-12 w-full rounded-2xl border border-stone-200 px-4 text-base text-stone-950 focus:outline-none focus:border-stone-950"
                                />
                            ...
                            <div className="mt-8 grid gap-6">
                              ...
                              <label className="block">
                                ...
                                <textarea
                                  ...
                                  rows={6}
                                  placeholder={t('application.cuentanosLaVerdadQueTipoDeEstabil', 'Cuéntanos la verdad: qué tipo de estabilidad buscas, por qué te quemaste de ciertas marcas y cómo tratarías a tu comunidad.')}
