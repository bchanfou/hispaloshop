            ...
            {loginMethod === 'email' ? (
              <form onSubmit={handleEmailLogin} className="space-y-4">
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <Input
                      ...
                      className="h-12 rounded-2xl border-stone-200 pl-10 text-base md:h-11 md:text-sm"
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="h-12 w-full rounded-full bg-stone-950 text-base font-medium text-white transition-colors hover:bg-black md:h-11 md:text-sm"
