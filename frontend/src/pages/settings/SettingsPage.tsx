...
function SettingsItem({ icon, iconClass, label, sublabel, to, onClick, rightContent }) {
  const inner = (
    <div className="flex items-center justify-between py-3 px-2 -mx-2 rounded-xl cursor-pointer group hover:bg-stone-50 active:bg-stone-100 active:scale-[0.98] transition-all duration-150">
