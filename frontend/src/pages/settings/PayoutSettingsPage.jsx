  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--color-cream)', ...font }}>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 17, fontWeight: 700, color: 'var(--color-black)' }}>Método de cobro</span>
      </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div style={{
              ...
              <AlertCircle size={18} color="var(--color-stone)" style={{ flexShrink: 0, marginTop: 2 }} />
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 28 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: 'var(--color-white)',
                  border: method === 'stripe' ? '2px solid var(--color-black)' : '1px solid var(--color-border)',
              ...
              >
                <div style={{
                  ...
                  background: method === 'stripe' ? 'var(--color-black)' : 'var(--color-surface)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
                }}>
                  <CreditCard size={20} color={method === 'stripe' ? 'var(--color-white)' : 'var(--color-stone)'} />
                </div>
                <div style={{ flex: 1 }}>
                  <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--color-black)', margin: 0 }}>Stripe Connect</p>
                ...
                {stripeConnected && method === 'stripe' && (
                  <div style={{
                    ...
                    <Check size={14} color="var(--color-white)" />
                  </div>
                )}
              </button>
              ...
              <button
                ...
                style={{
                  display: 'flex', alignItems: 'center', gap: 14, padding: 16,
                  background: 'var(--color-white)',
                  border: method === 'sepa' ? '2px solid var(--color-black)' : '1px solid var(--color-border)',
                  borderRadius: 'var(--radius-xl)',
                  cursor: 'pointer', textAlign: 'left', ...font,
                }}
              >
                <div style={{
                  width: 44, height: 44, borderRadius: 'var(--radius-lg)',
                  background: method === 'sepa' ? 'var(--color-black)' : 'var(--color-surface)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
                }}>
                  <Building2 size={20} color={method === 'sepa' ? 'var(--color-white)' : 'var(--color-stone)'} />
                </div>
                <div style={{ flex: 1 }}>
                  <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--color-black)', margin: 0 }}>Transferencia SEPA</p>
                  <p style={{ fontSize: 12, color: 'var(--color-stone)', margin: '2px 0 0' }}>
            ...
            {method === 'stripe' && (
              <div style={{
                ...
                <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--color-black)', margin: '0 0 8px' }}>
                  Stripe Connect
                </p>
                ...
                {stripeConnected ? (
                  ...
                  <>
                    <p style={{ fontSize: 13, color: 'var(--color-stone)', margin: '0 0 16px', lineHeight: 1.5 }}>
            ...
            {method === 'sepa' && (
              <div style={{
                ...
                <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--color-black)', margin: '0 0 16px' }}>
                ...
                {sepaConfigured && !iban && (
                  <div style={{
                    ...
                    <Building2 size={16} color="var(--color-stone)" />
                    <div>
                ...
                <div style={{ marginBottom: 14 }}>
                  <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--color-black)', marginBottom: 6 }}>
                    IBAN
                  </label>
                  <input
                    type="text"
                ...
                <button
                  ...
                  style={{
                    width: '100%', padding: 14,
                    background: (iban.trim() && accountName.trim()) ? 'var(--color-black)' : 'var(--color-surface)',
                    color: (iban.trim() && accountName.trim()) ? 'var(--color-white)' : 'var(--color-stone)',
                    border: 'none', borderRadius: 'var(--radius-lg)',
                    fontSize: 14, fontWeight: 600, cursor: 'pointer',
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                    ...font,
            ...
            {isProducer && (
              <div style={{
                ...
                <p style={{ fontSize: 13, fontWeight: 600, color: 'var(--color-black)', margin: '0 0 4px' }}>
                  Vendedores y productores
                </p>
                <p style={{ fontSize: 12, color: 'var(--color-stone)', margin: 0, lineHeight: 1.5 }}>
