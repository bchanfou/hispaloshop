...
export default function LoyaltyPage() {
  ...
  return <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[480px] mx-auto px-4 py-5">
        ...
        background: 'linear-gradient(135deg, #1B6B40, #155534)'
      }}>
        ...
        <div className="flex flex-col gap-3 mb-8">
          ...
          return <div key={reward.id} className={`flex items-center gap-4 rounded-2xl border p-4 transition-opacity ${canAfford ? 'border-stone-200' : 'border-stone-100 opacity-50'}`}>
                ...
                <button onClick={() => handleRedeem(reward.id)} disabled={!canAfford || isRedeeming} className="btn btn-primary btn-sm shrink-0">
        ...
        <AnimatePresence>
          ...
          opacity: 1
              ...
              <div className="flex flex-col gap-3">
                {activeCodes.map(r => <div key={r.discount_code} className="flex items-center justify-between rounded-2xl border-2 border-dashed p-4" style={{
              background: 'var(--color-accent-light)',
              borderColor: 'var(--color-accent-border)'
            }}>
                    <div>
                      <div className="text-xl font-bold tracking-widest" style={{
                  color: 'var(--color-accent)'
                    ...
                    <button onClick={() => handleCopy(r.discount_code)} className="btn btn-ghost btn-sm">
