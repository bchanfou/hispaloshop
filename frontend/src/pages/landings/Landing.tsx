    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 pt-28 pb-20 md:pt-36 md:pb-28 overflow-hidden">
        ...
        <motion.button
          ...
          className="bg-stone-950 text-white rounded-full px-8 py-4 text-base font-semibold hover:bg-stone-800 transition-colors cursor-pointer"
        >
          Empieza gratis &rarr;
        </motion.button>
      ...
      {ROLES.map((role, index) => {
        ...
        return (
          ...
          >
            <div
              className={`max-w-5xl mx-auto flex flex-col ${isEven ? 'md:flex-row-reverse' : 'md:flex-row'} items-start gap-12 md:gap-20`}
            >
              {/* Text column */}
              <div className="flex-1 max-w-xl">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-stone-950 text-white rounded-full px-6 py-3 text-sm font-semibold hover:bg-stone-800 transition-colors cursor-pointer"
                >
                  {role.cta} &rarr;
                </button>
              </div>
