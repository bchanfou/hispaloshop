...
const S = {
  font: "var(--hs-font, -apple-system, BlinkMacSystemFont, 'SF Pro Display', sans-serif)",
  black: 'var(--hs-black, #0A0A0A)',
  white: 'var(--hs-white, #FFFFFF)',
  bg: 'var(--hs-bg, #F5F5F7)',
  surface: 'var(--hs-surface, #FFFFFF)',
  surface2: 'var(--hs-surface-2, #F5F5F7)',
  text1: 'var(--hs-text-1, #1D1D1F)',
  text2: 'var(--hs-text-2, #6E6E73)',
  text3: 'var(--hs-text-3, #AEAEB2)',
  border: 'var(--hs-border, rgba(0,0,0,0.08))',
  borderMed: 'var(--hs-border-med, rgba(0,0,0,0.12))',
  purple: 'var(--hs-purple, #5856D6)',
  purpleBg: 'var(--hs-purple-bg, #F2F2FF)',
  green: 'var(--hs-green, #34C759)',
  greenBg: 'var(--hs-green-bg, #F0FBF4)',
  orange: 'var(--hs-orange, #FF9500)',
  orangeBg: 'var(--hs-orange-bg, #FFF8EC)',
  shadowSm: 'var(--hs-shadow-sm, 0 2px 10px rgba(0,0,0,0.07))',
  shadowMd: 'var(--hs-shadow-md, 0 4px 20px rgba(0,0,0,0.09))',
  rLg: 'var(--hs-r-lg, 16px)',
  rXl: 'var(--hs-r-xl, 22px)',
  rFull: 'var(--hs-r-full, 9999px)',
  ease: 'var(--hs-ease, cubic-bezier(0.4,0,0.2,1))',
};
    ...
    <div style={{
      ...
      {expanded && (
        <div style={{
          ...
          fontFamily: 'var(--hs-font-mono, monospace)',
          lineHeight: 1.6,
          whiteSpace: 'pre-wrap',
