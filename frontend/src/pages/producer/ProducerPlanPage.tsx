...
function PlanCard({ plan, currentPlan, isCancelling, onUpgrade, changing }) {
        ...
        <div className="flex items-center gap-3 bg-stone-100 border border-stone-200 rounded-2xl p-4 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-stone-500">
              ...
              {planData?.grace_period_ends_at && (
                <> Tienes hasta el {new Date(planData.grace_period_ends_at).toLocaleDateString('es-ES')}.</>
              )}
            </p>
          </div>
        </div>
      ...
      {isCancelledPending && (
        <div className="flex items-center gap-3 bg-stone-50 border border-stone-200 rounded-2xl p-4 mb-4">
          ...
          <button
            ...
            disabled={cancelling}
            className="text-sm font-medium text-stone-950 hover:underline disabled:opacity-50 shrink-0"
          >
            Reactivar
          </button>
        </div>
