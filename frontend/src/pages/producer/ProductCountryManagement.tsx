...
function MarketRow({ market, onChange, onRemove }) {
  ...
  return (
    <div className={`bg-white rounded-2xl border p-4 transition-all ${market.active ? (isValid ? 'border-stone-400 bg-stone-50' : 'border-stone-200 bg-stone-50') : 'border-stone-200'}`}
      ...
      {availableCodes.length > 0 && (
        <div className="flex items-center gap-2">
          <select
            ...
            className="text-sm border border-stone-200 rounded-2xl px-3 py-2 bg-white"
