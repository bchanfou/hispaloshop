      ...
      <button type="button" onClick={() => id && navigate(`/products/${id}`)} className="relative w-full overflow-hidden rounded-2xl bg-stone-950 cursor-pointer text-left flex h-[112px]">
        <div className="flex flex-col justify-center px-5 py-4 flex-1 min-w-0">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-stone-400">{i18n.t('discover.seleccionDelDia', 'Selección del día')}</span>
          </div>
...
export default function DiscoverPage() {
  ...
  return <div className="min-h-screen bg-white pb-20">
      <SEO title="Explorar — Hispaloshop" description={i18n.t('discover.descubreProductosArtesanalesTiendas', 'Descubre productos artesanales, tiendas verificadas y recetas de la comunidad.')} />
      ...
      <div className="px-4 pb-4">
        <Link to="/collections" className="flex items-center justify-between rounded-2xl bg-stone-950 px-5 py-4 no-underline group">
          <div>
            ...
            <p className="text-[12px] text-stone-400 mt-0.5">{i18n.t('discover.seleccionesDeProductosConHistoria', 'Selecciones de productos con historia')}</p>
          </div>
