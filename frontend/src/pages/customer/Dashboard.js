        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <nav className="bg-white rounded-xl border border-stone-200 overflow-hidden">
              <Link to="/dashboard/orders" className="flex items-center justify-between p-4 hover:bg-stone-50 border-b border-stone-100">
              ...
              <Link to="/dashboard/profile" className="flex items-center justify-between p-4 hover:bg-stone-50 border-b border-stone-100">
                <div className="flex items-center gap-3">
              ...
              <Link to="/dashboard/wishlist" className="flex items-center justify-between p-4 hover:bg-stone-50 border-b border-stone-100">
                <div className="flex items-center gap-3">
                  <Heart className="w-5 h-5 text-primary" />
                  <span>Lista de Deseos</span>
                </div>
              </Link>
              <Link to="/dashboard/followed-stores" className="flex items-center justify-between p-4 hover:bg-stone-50">
                <div className="flex items-center gap-3">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-stone-200 p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <Link to="/dashboard/orders" className="text-primary text-sm hover:underline flex items-center gap-1">
            ...
            <div className="bg-white rounded-xl border border-stone-200 p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <Link to="/dashboard/profile" className="text-primary text-sm hover:underline flex items-center gap-1">
              ...
              {addresses.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {addresses.length > 2 && (
                    <Link to="/dashboard/profile" className="border border-dashed border-stone-300 rounded-lg p-4 flex items-center justify-center hover:bg-stone-50 transition-colors">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <Link to="/dashboard/orders" className="bg-white rounded-xl border border-stone-200 p-6 hover:shadow-md transition-shadow text-center">
