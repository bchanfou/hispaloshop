...
const STATUS_ORDER = { pending: 0, answered: 1, closed: 2 };

function RFQCard({ rfq, isProducer }) {
        ...
        {expanded && (
          ...
          >
            <div className="px-4 pb-4 border-t border-stone-100 pt-3">
              ...
              {!rfq.products?.length && rfq.quantity && (
                <div className="mb-3">
        ...
        {activeQuery.isLoading ? (
          ...
          <div className="space-y-3">
            ...
            {filteredAndSorted.map((rfq) => (
              <RFQCard key={rfq.rfq_id} rfq={rfq} isProducer={isProducer} />
            ))}
          </div>
        )}
      </div>
