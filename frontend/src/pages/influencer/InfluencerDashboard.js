            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 mb-4">
                  <p className="text-xs font-medium text-purple-800 mb-2">💡 {t('influencer.howCommissionWorks')}</p>
                  ...
                  <div className="mt-2 text-xs text-purple-600 bg-purple-100 rounded p-2">
                    ...
                    <p>• <strong>{t('influencer.yourCommission')}: €2.70</strong> (15% de €18)</p>
                  </div>
                </div>
          ...
          <Card className="mt-6 border-2 border-green-200 bg-green-50/50">
            ...
            <CardContent>
              ...
              <div className="mt-4 p-3 bg-white rounded-lg border border-stone-200">
                <p className="text-sm text-[#7A7A7A]">
                  <strong>ℹ️ {t('influencer.paymentPolicy')}:</strong> {t('influencer.paymentPolicyDesc')}
                </p>
              </div>
            </CardContent>
          </Card>
