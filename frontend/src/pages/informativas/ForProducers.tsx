...
export default function ForProducers() {
  ...
  return <div>
      <SEO title="Soy Productor — Hispaloshop" description={i18n.t('for_producers.conectaTuProduccionConImportadoresY', 'Conecta tu producción con importadores y clientes de todo el mundo. Expande tu alcance, digitaliza tu catálogo y accede a nuevas oportunidades comerciales.')} />
      ...
      <section className="info-hero bg-[#0A0A0A] min-h-[60vh] flex items-center pt-[120px] pb-12 px-4">
        <div className="max-w-[900px] mx-auto w-full text-center">
          ...
          <p className="text-white/80 text-lg md:text-xl mb-8">{i18n.t('for_producers.uneteALaPlataformaQueConectaProduc', 'Únete a la plataforma que conecta productores con importadores y clientes de todo el mundo. Digitaliza tu catálogo y accede a nuevas oportunidades comerciales.')}</p>
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <ol className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <li className="bg-stone-50 rounded-2xl p-6 text-center">
              ...
              <b>{i18n.t('for_producers.registrateGratis', 'Regístrate gratis')}</b> y crea tu perfil de productor.
            </li>
            <li className="bg-stone-50 rounded-2xl p-6 text-center">
              <span className="block text-3xl mb-2">2</span>
              <b>{i18n.t('for_producers.publicaTuCatalogo', 'Publica tu catálogo')}</b> con fotos y descripciones.
            </li>
            <li className="bg-stone-50 rounded-2xl p-6 text-center">
      ...
      <section className="info-benefits bg-stone-50 py-16 px-4">
        <div className="max-w-[900px] mx-auto">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-6 text-lg text-stone-700">
            <li>{i18n.t('for_producers.accesoInmediatoAUnaRedGlobalDeImp', 'Acceso inmediato a una red global de importadores verificados.')}</li>
            <li>{i18n.t('for_producers.herramientasParaDestacarTuMarcaYPr', 'Herramientas para destacar tu marca y productos.')}</li>
            <li>Visibilidad internacional y posicionamiento en buscadores.</li>
            <li>Soporte personalizado y recursos educativos.</li>
            <li>{i18n.t('for_producers.opcionesDePromocionPremiumSegunTuP', 'Opciones de promoción premium según tu plan.')}</li>
            <li>{i18n.t('for_producers.gestionEficienteDeContactosYOportun', 'Gestión eficiente de contactos y oportunidades.')}</li>
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center">
            ...
            <div className="bg-stone-50 rounded-2xl p-8 text-center flex-1">
              ...
              <p className="text-stone-500 text-sm">{i18n.t('for_producers.paraProductoresEnCrecimiento', 'Para productores en crecimiento')}</p>
            </div>
            <div className="bg-stone-50 rounded-2xl p-8 text-center flex-1">
              ...
              <p className="text-stone-500 text-sm">{i18n.t('for_producers.maximaVisibilidadYVentajas', 'Máxima visibilidad y ventajas')}</p>
            </div>
          </div>
          <p className="text-center text-sm text-stone-500 mt-6">{i18n.t('for_producers.sinTarjetaDeCreditoParaEmpezar', 'Sin tarjeta de crédito para empezar')}</p>
        </div>
      </section>
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <details>
              ...
              <p className="text-stone-600 mt-2">{i18n.t('for_producers.elRegistroEsGratuitoPuedesAcceder', 'El registro es gratuito. Puedes acceder a funciones avanzadas con planes premium.')}</p>
            </details>
            <details>
              <summary className="font-semibold text-stone-800 cursor-pointer">¿Qué tipo de productos puedo publicar?</summary>
              <p className="text-stone-600 mt-2">{i18n.t('for_producers.puedesPublicarCualquierProductoQueC', 'Puedes publicar cualquier producto que cumpla con nuestras políticas y estándares de calidad.')}</p>
            </details>
            <details>
              <summary className="font-semibold text-stone-800 cursor-pointer">¿Cómo contacto a los importadores?</summary>
              <p className="text-stone-600 mt-2">{i18n.t('for_producers.unaVezRegistradoPodrasContactarImp', 'Una vez registrado, podrás contactar importadores directamente desde la plataforma.')}</p>
            </details>
            <details>
              <summary className="font-semibold text-stone-800 cursor-pointer">¿Qué beneficios obtengo con un plan premium?</summary>
              <p className="text-stone-600 mt-2">{i18n.t('for_producers.mayorVisibilidadAccesoPrioritarioA', 'Mayor visibilidad, acceso prioritario a oportunidades y herramientas exclusivas para potenciar tu negocio.')}</p>
            </details>
            <details>
              <summary className="font-semibold text-stone-800 cursor-pointer">¿Puedo vender tanto a particulares como a empresas?</summary>
              <p className="text-stone-600 mt-2">{i18n.t('for_producers.siPuedesVenderTantoAConsumidoresF', 'Sí, puedes vender tanto a consumidores finales como a importadores y empresas.')}</p>
            </details>
            <details>
              <summary className="font-semibold text-stone-800 cursor-pointer">¿Qué soporte ofrece Hispaloshop?</summary>
              <p className="text-stone-600 mt-2">{i18n.t('for_producers.soportePersonalizadoRecursosEducativ', 'Soporte personalizado, recursos educativos y asesoría en comercio internacional.')}</p>
            </details>
          </div>
        </div>
      </section>
      ...
      <section className="info-cta bg-[#0A0A0A] py-16 px-4 text-center">
        <div className="max-w-[900px] mx-auto">
          ...
          <p className="text-white/70 text-lg mb-8">{i18n.t('for_producers.uneteACientosDeProductoresQueYaEs', 'Únete a cientos de productores que ya están creciendo con Hispaloshop.')}</p>
