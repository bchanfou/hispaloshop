    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          {errors.email && touched.email ? <p className="mt-1 text-xs text-red-600">{errors.email}</p> : null}
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            ...
            {errors.firstName && touched.firstName ? <p className="mt-1 text-xs text-red-600">{errors.firstName}</p> : null}
          </div>
          <div>
            ...
            {errors.lastName && touched.lastName ? <p className="mt-1 text-xs text-red-600">{errors.lastName}</p> : null}
          </div>
        </div>
        ...
        <div>
          ...
          {errors.password && touched.password ? <p className="mt-1 text-xs text-red-600">{errors.password}</p> : null}
      ...
      <div className="space-y-3">
        <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-stone-200 bg-stone-50 p-3">
          ...
          <span className="text-sm text-stone-600">
            Acepto los <a href="/terms" className="font-medium text-stone-950 hover:underline">términos</a> y la <a href="/privacy" className="font-medium text-stone-950 hover:underline">política de privacidad</a><span className="ml-1 text-red-500">*</span>
          </span>
        </label>
