...
REELS = [
    {"post_id": f"{PREFIX}reel_laura1", "user_id": f"{PREFIX}inf_laura",
     ...
     "location": "Barcelona", "video_url": "https://samplelib.com/lib/preview/mp4/sample-5s.mp4",
    ...
    {"post_id": f"{PREFIX}reel_carlos1", "user_id": f"{PREFIX}inf_carlos",
     ...
     "location": "Madrid", "video_url": "https://samplelib.com/lib/preview/mp4/sample-10s.mp4",
    ...
    {"post_id": f"{PREFIX}reel_oliva1", "user_id": f"{PREFIX}prod_oliva",
     ...
     "location": "Jaén", "video_url": "https://samplelib.com/lib/preview/mp4/sample-15s.mp4",
    ...
    {"post_id": f"{PREFIX}reel_jamon1", "user_id": f"{PREFIX}prod_jamon",
     ...
     "location": "Azuaga", "video_url": "https://samplelib.com/lib/preview/mp4/sample-20s.mp4",
